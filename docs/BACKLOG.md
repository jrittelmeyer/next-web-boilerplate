...
- **Maintenance-only** (Tier 3 **G**) — the honest "we're done" option: let Renovate drive
  ...
  manual dashboard-approval clicks). The widening fix **SHIPPED 2026-07-22**
  (shipped row below); confirm PRs actually open at the next Monday window
  (2026-07-27). The 7 approved
...
> and none of it code — and all four of its rows shipped same-day (shipped table
> below); the audit ledger is clear again
