...
| `next` 16.3.1 taken — 2026-08-22 | 1 | 08-14-deferred take, contrarian-passed (sharp-only override removal, postcss kept — exact pin). `16.3.2` shipped meanwhile (routine, no advisory) — stayed on 16.3.1. New durable e2e guard proves image-opt + OG still transform, not just compile | [CHANGELOG](../CHANGELOG.md) |
