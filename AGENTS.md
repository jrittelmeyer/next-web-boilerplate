...
| [calendar/](docs/context/calendar/) | calendars, events, civil time vs instants, the month grid — model · [api](docs/context/calendar/api.md) · [acl](docs/context/calendar/acl.md) · [remove-it](docs/context/calendar/remove-it.md) |
