...
// Data-table primitive (A26) — the canonical shadcn Table family. Presentational only
// (no client hooks, like card.tsx / skeleton.tsx): thin styled wrappers over the native
// table elements, so semantics + a11y come for free (a real <table> with <th> column
