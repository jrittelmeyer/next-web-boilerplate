...
- **Dual-home rule:** this skill may exist both in-repo (`.claude/skills/doc-audit/`)
  and globally (`~/.claude/skills/doc-audit/`). Keep the body generic and the two
  copies byte-identical; after editing one, sync the other verbatim. Project-specific
